...
lr = os.listdir('/media/yuride/date/Dataset/RGB_D_rail/train/rgb')
lr = [os.path.join('/media/yuride/date/Dataset/RGB_D_rail/train/rgb', img) for img in lr]
lr.sort()
gt = os.listdir('/media/yuride/date/Dataset/RGB_D_rail/train/gt')
gt = [os.path.join('/media/yuride/date/Dataset/RGB_D_rail/train/gt', gtimg) for gtimg in gt]
gt.sort()

depth = os.listdir('/media/yuride/date/Dataset/RGB_D_rail/train/d')
depth = [os.path.join('/media/yuride/date/Dataset/RGB_D_rail/train/d', dep) for dep in depth]
depth.sort()

bound = os.listdir('/media/yuride/date/Dataset/RGB_D_rail/train/boundary')
bound = [os.path.join('/media/yuride/date/Dataset/RGB_D_rail/train/boundary', edge) for edge in bound]
bound.sort()
...
# val NJU2K+LFSD
lrval = os.listdir('/media/yuride/date/Dataset/RGB_D_rail/value/rgb')
lrval = [os.path.join('/media/yuride/date/Dataset/RGB_D_rail/value/rgb', img) for img in lrval]
lrval.sort()


gtval = os.listdir('/media/yuride/date/Dataset/RGB_D_rail/value/gt')
gtval = [os.path.join('/media/yuride/date/Dataset/RGB_D_rail/value/gt', gtimg) for gtimg in gtval]
gtval.sort()

depthval = os.listdir('/media/yuride/date/Dataset/RGB_D_rail/value/d')
depthval = [os.path.join('/media/yuride/date/Dataset/RGB_D_rail/value/d', dep) for dep in depthval]
depthval.sort()
#
#
#
###Test
VT800_RGB = os.listdir('/media/yuride/date/Dataset/RGB_D_rail/test/rgb')
VT800_RGB = [os.path.join('/media/yuride/date/Dataset/RGB_D_rail/test/rgb', img) for img in VT800_RGB]
VT800_RGB.sort()

VT800_GT = os.listdir('/media/yuride/date/Dataset/RGB_D_rail/test/gt')
VT800_GT = [os.path.join('/media/yuride/date/Dataset/RGB_D_rail/test/gt', gtimg) for gtimg in VT800_GT]
VT800_GT.sort()

VT800_T = os.listdir('/media/yuride/date/Dataset/RGB_D_rail/test/d')
VT800_T = [os.path.join('/media/yuride/date/Dataset/RGB_D_rail/test/d', dep) for dep in VT800_T]
VT800_T.sort()
#
# ############################################
# lr = os.listdir('/media/yuride/date/Dataset/RGB_D_SOD/train/DUT_NJUNLPR/RGB')
# #lr = [os.path.join('/home/hjk/文档/轨道缺陷检测/Dataset/train/rgb', img) for img in lr]
# lr = [os.path.join('/media/yuride/date/Dataset/RGB_D_SOD/train/DUT_NJUNLPR/RGB', img) for img in lr]
# lr.sort()
# # print(lr)
# #gt = os.listdir('/home/hjk/文档/轨道缺陷检测/Dataset/train/gt')
# gt = os.listdir('/media/yuride/date/Dataset/RGB_D_SOD/train/DUT_NJUNLPR/GT')
# #gt = [os.path.join('/home/hjk/文档/轨道缺陷检测/Dataset/train/gt', gtimg) for gtimg in gt]
# gt = [os.path.join('/media/yuride/date/Dataset/RGB_D_SOD/train/DUT_NJUNLPR/GT', gtimg) for gtimg in gt]
# gt.sort()
#
# #depth = os.listdir('/home/hjk/文档/轨道缺陷检测/Dataset/train/d')
# depth = os.listdir('/media/yuride/date/Dataset/RGB_D_SOD/train/DUT_NJUNLPR/depth')
# #depth = [os.path.join('/home/hjk/文档/轨道缺陷检测/Dataset/train/d', dep) for dep in depth]
# depth = [os.path.join('/media/yuride/date/Dataset/RGB_D_SOD/train/DUT_NJUNLPR/depth', dep) for dep in depth]
# depth.sort()
#
# #bound = os.listdir('/home/hjk/文档/轨道缺陷检测/Dataset/train/boundary')
# bound = os.listdir('/media/yuride/date/Dataset/RGB_D_SOD/train/DUT_NJUNLPR/parrllex')
# #bound = [os.path.join('/home/hjk/文档/轨道缺陷检测/Dataset/train/boundary', edge) for edge in bound]
# bound = [os.path.join('/media/yuride/date/Dataset/RGB_D_SOD/train/DUT_NJUNLPR/parrllex', edge) for edge in bound]
# bound.sort()
#
#
#
...
# lrval = os.listdir('/media/yuride/date/Dataset/RGB_D_SOD/val/NJUNLPR/RGB')
# #lrval = [os.path.join('/home/hjk/文档/轨道缺陷检测/Dataset/value/rgb', img) for img in lrval]
# lrval = [os.path.join('/media/yuride/date/Dataset/RGB_D_SOD/val/NJUNLPR/RGB', img) for img in lrval]
# lrval.sort()
#
#
# #gtval = os.listdir('/home/hjk/文档/轨道缺陷检测/Dataset/value/gt')
# gtval = os.listdir('/media/yuride/date/Dataset/RGB_D_SOD/val/NJUNLPR/GT')
# #gtval = [os.path.join('/home/hjk/文档/轨道缺陷检测/Dataset/value/gt', gtimg) for gtimg in gtval]
# gtval = [os.path.join('/media/yuride/date/Dataset/RGB_D_SOD/val/NJUNLPR/GT', gtimg) for gtimg in gtval]
# gtval.sort()
#
# #depthval = os.listdir('/home/hjk/文档/轨道缺陷检测/Dataset/value/d')
# depthval = os.listdir('/media/yuride/date/Dataset/RGB_D_SOD/val/NJUNLPR/depth')
# #depthval = [os.path.join('/home/hjk/文档/轨道缺陷检测/Dataset/value/d', dep) for dep in depthval]
# depthval = [os.path.join('/media/yuride/date/Dataset/RGB_D_SOD/val/NJUNLPR/depth', dep) for dep in depthval]
# depthval.sort()
#
#
#
# ##Test
# VT800_RGB = os.listdir('/media/yuride/date/Dataset/RGB_D_SOD/test/NJU2K/RGB')
# VT800_RGB = [os.path.join('/media/yuride/date/Dataset/RGB_D_SOD/test/NJU2K/RGB', img) for img in VT800_RGB]
# VT800_RGB.sort()
#
# VT800_GT = os.listdir('/media/yuride/date/Dataset/RGB_D_SOD/test/NJU2K/GT')
# VT800_GT = [os.path.join('/media/yuride/date/Dataset/RGB_D_SOD/test/NJU2K/GT', gtimg) for gtimg in VT800_GT]
# VT800_GT.sort()
#
# VT800_T = os.listdir('/media/yuride/date/Dataset/RGB_D_SOD/test/NJU2K/depth')
# VT800_T = [os.path.join('/media/yuride/date/Dataset/RGB_D_SOD/test/NJU2K/depth', dep) for dep in VT800_T]
# VT800_T.sort()
